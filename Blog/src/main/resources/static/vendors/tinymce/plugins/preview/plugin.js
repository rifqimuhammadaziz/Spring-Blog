...
(function () {
    ...
    const getPreviewHtml = editor => {
      ...
      const previewHtml = '<!DOCTYPE main>' + '<main>' + '<head>' + headHtml + '</head>' + '<body id="' + encode(bodyId) + '" class="mce-content-body ' + encode(bodyClass) + '"' + dirAttr + '>' + editor.getContent() + preventClicksOnLinksScript + '</body>' + '</main>';
      return previewHtml;
    };
